...
public class ConsentSUPPage extends BaseClass {
    public ConsentSUPPage(Page page) {
        super(page);
    }
...
//        page.click("//div[@class='consent-agreement-option']//ion-segment-button[1]");
    ...
    public void ConsentInfoform2Borr(String borrowerSSN, String coborrowerSSN ) throws IOException {
        ...
        page.click("//yes-no-bool[@name='borrowerEdocsConsent']//ion-segment-button[1]");
        page.click("//yes-no-bool[@name='coborrowerEdocsConsent']//ion-segment-button[1]");
       pageDown();
