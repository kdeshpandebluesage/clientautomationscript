...
//        String  loannumber = "3000000588";
      ...
      //  clearAndFillText("input[name='userName']", username);
        clearAndFillText("input[name='userName-inputEl']", username);
      //  clearAndFillText("input[name='password']", password);
        clearAndFillText("input[name='password-inputEl']", password);
       // click("ion-button[id='loginButton']");
        click("span[id='btnLogin-btnIconEl']");
        //click("#btnLogin");
        System.out.println("TIB Login attempt complete.");
    }
}
//        click("#btnLoans");
//        page.waitForTimeout(6000);
