...
public class PortalCreditPage extends BaseClass {
    public PortalCreditPage(Page page) {
        super(page);
    }


    public void lopOrderCredit2BR() throws InterruptedException {
        page.click("//span[text()='Loan Processing']");
        page.click("//span[text()='New Credit Reports']");
        page.locator("//span[text()='Order Credit Reports']").waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE));
        page.click("//span[text()='Order Credit Reports']");
        page.click("//div[@data-selenium-id='applicantOrder']//input[@role='checkbox']");

        page.click("//span[text()='Add to Order']");

        String creditAgencydropdownToggleLocator = "//input[@name='ediProviderTypeId']/../following-sibling::td/div";
        String hoverTargetSelector = "//li[text()='Fannie Mae']";
