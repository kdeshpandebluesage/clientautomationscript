...
public class TwoBorr_1_Refinance_WilliamSBrennan_LIONLOPLOS_BSS {
...
//        page.navigate("https://sup-dev-lion.bluesageusa.com/apply/login");
       ...
       // List<Map<String, String>> data = ExcelUtil.readExcel("src/main/resources/SupremeLIONLOPLOSData.xlsx");
        List<Map<String, String>> data = ExcelUtil.readExcelWithTC("src/main/resources/BSSLIONLOPLOSData.xlsx","SUP_DSP_Sc1");
//        List<Map<String, String>> data = ExcelUtil.readExcel("src/main/resources/testdata.xlsx");
        ...
        for (Map<String, String> row : data) {
            new LoanPurposeBSSPage(page).refinanceloanpurposeform(row.get("LoanPurposePhoneNumber"));
        }
