...
public class TwoBorr_18_Purchase_LenaJWren_LIONLOPLOS_Supreme {
...
//        List<Map<String, String>> data = ExcelUtil.readExcel("src/main/resources/SupremeLIONLOPLOSData.xlsx");
        List<Map<String, String>> data = ExcelUtil.readExcelWithTC("src/main/resources/SupremeLIONLOPLOSData.xlsx","SUP_DSP_Sc18");
