...
public class TwoBorr_25_Purchase_JeromeUMilner_LIONLOPLOS_Supreme {
...
//        page.navigate("https://sup-dev-lion.bluesageusa.com/apply/login");
       ...
       // List<Map<String, String>> data = ExcelUtil.readExcel("src/main/resources/SupremeLIONLOPLOSData.xlsx");
        List<Map<String, String>> data = ExcelUtil.readExcelWithTC("src/main/resources/SupremeLIONLOPLOSData.xlsx","SUP_DSP_Sc25");
