...
public class TwoBorr_3_Purchase_DonnaLBurns_LIONLOPLOS_BSS {
...
//        page.navigate("https://sup-uat-lion.bluesageusa.com/apply/login");
        page.navigate("https://lion-bluesage-dev.firebaseapp.com/apply/login");


      //  List<Map<String, String>> data = ExcelUtil.readExcel("src/main/resources/SupremeLIONLOPLOSData.xlsx");
        List<Map<String, String>> data = ExcelUtil.readExcelWithTC("src/main/resources/BSSLIONLOPLOSData.xlsx","SUP_DSP_Sc3");
//        List<Map<String, String>> data = ExcelUtil.readExcel("src/main/resources/testdata.xlsx");
        ...
        for (Map<String, String> row : data) {
            new LoanPurposeBSSPage(page).loanpurposeform(row.get("LoanPurposePhoneNumber"));
        }
...
//        }
        for (Map<String, String> row : data) {
            new ApplicationInfoBSSPage(page).applicationInformation(row.get("ApplicationInfo2BrPrimaryApplicantFirstName"), row.get("ApplicationInfo2BrPrimaryApplicantMiddleName"),row.get("ApplicationInfo2BrPrimaryApplicantLastName"),
