...
public class PurchaseLoanTest {
    ...
    void testFormFill() throws IOException {
        ...
        for (Map<String, String> row : data) {
           // new PurchaseLoanPage(page).purchaseInfoform(row.get("RCompanyName"),row.get("RFirstName"),row.get("RLastName"),row.get("REmail"),row.get("Rphonenumber"));
        }
