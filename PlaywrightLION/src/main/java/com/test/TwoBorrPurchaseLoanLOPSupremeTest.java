...
public class TwoBorrPurchaseLoanLOPSupremeTest {
...
//        page.navigate("https://sup-uat-lion.bluesageusa.com/apply/login");
        ...
        List<Map<String, String>> data = ExcelUtil.readExcelWithTC("src/main/resources/MovementData.xlsx","SUP_DSP27");
...
//        }
        for (Map<String, String> row : data) {
            new ApplicationInfoSUPPage(page).applicationInformation(row.get("ApplicationInfo2BrPrimaryApplicantFirstName"), row.get("ApplicationInfo2BrPrimaryApplicantLastName"),
                    ...
                    row.get("ApplicationInfo2BrPrimaryApplicantStateName"), row.get("ApplicationInfo2BrPrimaryApplicantzipcode"), row.get("ApplicationInfo2BrPrimaryApplicantRent"),row .get ("ApplicationInfo2BrPrimaryApplicantMovedMonthYear"),row.get("ApplicationInfo1BrPrimaryMaritalStatus")
                     );
        }
        for (Map<String, String> row : data) {
