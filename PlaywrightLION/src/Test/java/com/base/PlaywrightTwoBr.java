...
//
//        String SingleBrRefiAppFirstBrName = row.get("SingleBrRefiAppFirstBrName");
//        String SingleBrPurchaseAppFirstBrName = row.get("SingleBrRPurchaseAppFirstBrName");
//
//        String TwoBrPrimaryAppFirstBrName = row.get("AppFirstBrName");
//        String TwoBrSecondaryAppFirstBrName = row.get("AppFirstBrName");
...
//            applicationInfoPage.applicationInformation(AppFirstBrName,AppLastBrName,AppFirstBRBOD,AppInoFirstBrAddressline,AppInfoFirtBRCityName,AppInfoFirstBrStateName,AppInfoFirstBRRent,AppInoFirstBrzipcode,movedMonthYear);
//
