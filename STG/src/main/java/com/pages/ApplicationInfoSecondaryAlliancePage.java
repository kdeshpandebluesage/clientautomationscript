...
public class ApplicationInfoSecondaryAlliancePage extends BaseClass {
//    public ApplicationInfoSecondarySUPPage(com.microsoft.playwright.Page page) {
//        super(page);
//    }
public ApplicationInfoSecondaryAlliancePage(Page page) {
    super(page);
}

    public void applicationSecondaryInformation(String applicationInfo2BrSecondaryApplicantFirstName, String ApplicationInfo2BrSecondaryApplicantFirstName, String ApplicationInfo2BrSecondaryApplicantLastName, String ApplicationInfo2BrSecondaryApplicantBOD, String ApplicationInfo2BrSecondaryApplicantMobNumber, String ApplicationInfo2BrSecondaryApplicantEmail, String ApplicationInfo2BrSecondaryApplicantAddressline , String ApplicationInfo2BrSecondaryApplicantCityName , String ApplicationInfo2BrSecondaryApplicantStateName, String ApplicationInfo2BrSecondaryApplicantzipcode, String ApplicationInfo2BrSecondaryApplicantRent ) throws IOException {
