...
public class TwoBorr_2_Refinance_RichardJCoss_LIONLOPLOS_3Rivers {
...
//        page.navigate("https://mam-uat-lion.bluesagedlp.com/mam/apply/login");
       ...
       // List<Map<String, String>> data = ExcelUtil.readExcel("src/main/resources/SupremeLIONLOPLOSData.xlsx");
        List<Map<String, String>> data = ExcelUtil.readExcelWithTC("src/main/resources/3RiversLIONLOPLOSData.xlsx","SUP_DSP_Sc2");
